...
bool MovementsPositionState::isFree          (const std::pair<int, int> & position, const std::vector<std::shared_ptr<Figure>> & figuresOnBoard)
{
...
bool MovementsPositionState::isEnemyFigureOnPosition(const std::shared_ptr<Figure> figure, const std::vector<std::shared_ptr<Figure>> & figuresOnBoard, const std::pair<int,int> & calculatedPosition)
{
...
bool MovementsPositionState::isTeamFigureOnPosition (const std::shared_ptr<Figure> figure, const std::vector<std::shared_ptr<Figure>> & figuresOnBoard, const std::pair<int,int> & calculatedPosition)
{
    std::shared_ptr<Figure> figureOnPosition = getFigureOnPosition(calculatedPosition, figuresOnBoard);
    if(isFree(calculatedPosition, figuresOnBoard))
        return false;

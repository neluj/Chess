...
private:
    ...
    bool enemysPossibleMovement(const std::shared_ptr<Figure> king, const std::shared_ptr<std::pair<int,int>> & newPosition, const std::vector<std::shared_ptr<Figure>> & figuresOnBoard);
